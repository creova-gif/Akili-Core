...
- Youth entrepreneur based in Halton Hills, Ontario, Canada
...
- KilimoAI: Bilingual Swahili/English AI tutoring for East Africa
  (Note: KilimoAI and Elimu AI are related — Justin to confirm)
...
def get_knowledge_for_agent(agent: str) -> str:
    ...
    Call this when initializing agent system prompts.
    """
